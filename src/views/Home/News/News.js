...
import { faEdit, faTrash, faInfo, faNewspaper } from '@fortawesome/free-solid-svg-icons';
        ...
        },
        {
            ...
            render: (item) => (
                <div className="d-flex">
                    ...
                    <Link to={`/Home/NewsInfo/${item.id}`} className="btn" style={{ height: '20px', width: '20px', fontSize: '1rem', border: 'none' }} title="Info">
